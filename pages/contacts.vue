      ...
      <div class='flex'>
          ...
          <div class='flex flex-row justify-between w-540'>
            <div class='flex flex-col'>
              ...
              <div class='flex flex-col Comfortaa mb-12 '>
                ...
                <div class='text-Green leading-10 Comfortaa'>
                  +998 97 722 26 10
                </div>
              </div>
              <div class='flex flex-col Comfortaa mb-12 '>
                <div class='flex flex-row mb-1'><img src='/icon/location.svg' class='mr-3'>Адрес:</div>
            ...
            <div class='flex flex-col'>
              ...
              <div class='Comfortaa mb-12'>Мы в Соц. Сетях.:
                <div>
                  <ul class='flex'>
                    <li class='flex-1 m-3'>
                      <a href='#'>
        ...
        <div class='flex flex-wrap w-1/2 px-3 bg-BGproducts px-4 rounded-20'>
          ...
          <div>
            ...
            <input class='py-4 px-6 mt-6 w-full rounded-xl' placeholder='*Ваш номер телефона'>
            <input class='py-4 px-6 mt-6 w-full rounded-xl' placeholder='Ваша организация'>
          </div>

          <button class='Comfortaa bg-Green py-2 px-8 mt-6 text-BGproducts rounded-xl'>
            Отправить
          </button>
