    ...
    <Container>
      <div class="flex flex-row justify-between items-center py-12 text-white Comfortaa">
        <div class="flex flex-col">
          <a href>
            <img src="/foot-logo.png" class="max-w-129" />
          </a>
        </div>
        <div class="flex flex-col">
          <div class="mb-5">
        ...
        <div class="flex flex-col">
          <div class="mb-5">
            <p class="mb-5">Связаться с нами:</p>
            <p>+998 90 995 5959</p>
          </div>
          <div>
              ...
              <li class="flex-1 m-3">
                <a href="#">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M10.5054 14.2482L14.4088 12L10.5054 9.75183V14.2482Z" fill="white" />
                    <path
