<template>
  <div class="flex relative Comfortaa">
    <div
      class="absolute h-full -left-20 cursor-pointer flex items-center justify-center"
    ...
    >
      <template #customPaging>
        <div class="w-3 h-3 rounded-full custom-slider-dots" />
      </template>
      <slot />
    </VueSlickCarousel>

    <div
      class="absolute h-full -right-20 cursor-pointer flex items-center justify-center"
